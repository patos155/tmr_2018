...
//Adafruit_MLX90614_Patos155 mlx2 = Adafruit_MLX90614_Patos155();
//delantero
...
//Declaracion de Variables para sensores
  ...
  //Ultrasonicos 
     ...
     //Izquierdo
       const int trigPin_L= 33; // Pin disparador. Se puede usar otro pin digital
       const int echoPin_L= 31; // Pin eco. Se puede usar otro pin digital
   //Infrarojos
...
//Variables de control
    ...
    // espara para los giros
       int t_giroi=4100;      //tiempo para los giros de 90°
       int t_girod=4600;      //tiempo para los giros de 90°
       int t_u=11800;
       int ineD=2000;
       int ineI=2150;        
