...
//Variables de control
    ...
    // espara para los giros
       int t_giroi=4200;      //tiempo para los giros de 90°
       int t_girod=5000;      //tiempo para los giros de 90°
       int t_u=9500;
       int ineD=2500;
       int ineI=2800;        
       int ine_ng=3000;       //inercia zona negra
