...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void loop() {
  //se guardan datos de los sensores RGB
  leerRGB();
 ...
 Moverse(velD,velI);
  if(dl3==negro && dl6==negro){Moverse(velD,velI);}
  
  /*/Centrado
  if((dl4 == negro && dl5 == negro) || (dl8==blanco && dl7==blanco && dl2==blanco && dl1==blanco)){
    Moverse(velD,velI);
    ultra();
    if (cm<10 && cm>1){
      //RETROCEDER
 ...
 //Curvas de 90°////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if( (dl2==negro) || (dl1==negro && dl2==negro)){
    Moverse(200,-250);
  }
 ...
 if(dl1==negro && dl8==negro){
  ...
  while(true){
    leerRGB();
   /* if((v2>500 && v2<1000) && (v1>550 && v1<1000) ){
      Moverse(velD, velI);
      delay(1000);
      break;
     }*/
