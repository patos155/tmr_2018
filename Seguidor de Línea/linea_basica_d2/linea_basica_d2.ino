...
void loop() {
  ...
  if(dl3==blanco && dl6==blanco){
    ...
    if(dl6==negro && dl3==blanco){
      Moverse(-120,180);
    }
    if(dl1==negro && dl8==blanco){
      Moverse(180,-120);
    }
    if(dl8==negro && dl1==blanco){
      Moverse(-120,180);
    }
    if(dl1==negro && dl3==negro && dl6==blanco && dl8==blanco){
      Moverse(190,-110);
    }
    if(dl8==negro && dl6==negro && dl3==blanco && dl1==blanco){
      Moverse(-110,190);
    }
  }
}
...
void leerInfra(){
  ...
  if (l1<=bco-20){dl1=1;} else {dl1=0;}
  //if (l2<=bco){dl2=1;} else {dl2=0;}
  if (l3<=bco-20){dl3=1;} else {dl3=0;}
