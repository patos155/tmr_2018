...
void loop() {
  ...
  /*if(dl1==negro && dl8==negro){
    ...
    for(int i=1;i<=7;i++){
      leerRGB();
      ///Verificar si hay algun verde
      //sensor izq
      if(r2>900 && v2>1300 && a2>1500 && r2<1550 && v2<1700 && a2<1900){
        izq=true;
      }else{
        izq=false;
      }
      //sensor der
      if(r1>900 && v1>1000 && a1>1500 && r1<1500 && v1<1700 && a1<2050){
        der=true;
      }else{
        der=false;
      } 
  ...
  //Centrado
  if((dl1==blanco && dl2==blanco && dl3==blanco && dl4==negro && dl5==negro && dl6==blanco && dl7==blanco && dl8==blanco) || (dl1==blanco && dl2==blanco && dl3==blanco && dl4==blanco && dl5==blanco && dl6==blanco && dl7==blanco && dl8==blanco)){
    Moverse(velD,velI);
    //leerInfra();
